...
layout = [  [sg.Text('Developed by Hoang D. Nguyen and Myoungsu Shin*')],
            ...
            [sg.Text('Steel reinforcement ratio at bottom of slab',size=(40, 1)), sg.Input('',key='-f5-',size=(30, 1)),sg.Text('%')],
            [sg.Text('Steel reinforcement ratio at top of slab',size=(40, 1)),sg.Input('',key='-f6-',size=(30, 1)),sg.Text('%')]],title='Input parameters',title_color='white')],
            [sg.Frame(layout=[
